 ...
 */
package es.albarregas.serviciomavenclientes;

import es.albarregas.xv.NewWebService_Service;
...
public class pruebas extends HttpServlet {
    ...
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8084/ServicioMaven/NewWebService.wsdl")
